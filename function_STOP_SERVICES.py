# This script stops services in the root folder and all services in a folder/multiple folders on ArcGIS Server.
...
def main(username, password, serverName, serverPort, stopOrStart):
    ...
    It stops services in both the root folder and within specified folders.
    ...
    Args:
        ...
        stopOrStart (str): Action to perform (STOP)
    """
    
    print("This tool is a sample script that stops all services in a folder.")
    print()
